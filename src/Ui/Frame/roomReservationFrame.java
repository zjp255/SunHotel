...
public class roomReservationFrame extends JFrame {
   ...
   public roomReservationFrame(TopButtonPanel owner)
   {
       this.owner = owner;
       addWindowListener(new WindowAdapter() {
           public void windowClosing(WindowEvent e) {
               owner.setRoomReservationFrame(null);
           }});

       setTitle("客户预定");
       setIconImage(Toolkit.getDefaultToolkit().getImage("Source/预定.png"));
       setSize(595,650);
       ...
       JLabel topLabel = new JLabel("预定信息");
       ...
       amountList = new JTable(new Object[][]{},new String[]{"宾客姓名","联系电话","房间类型","房间编号","预抵时间","保留时间","预定时间","备注"});
